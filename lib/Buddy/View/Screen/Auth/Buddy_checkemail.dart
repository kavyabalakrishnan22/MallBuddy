...
import 'buddy_login_page.dart';



class BuddyCheckMailScreen extends StatelessWidget {
  const BuddyCheckMailScreen({super.key});
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [SizedBox(height: 200,),
              ...
              ElevatedButton(
                onPressed: () {Navigator.push(context, MaterialPageRoute(builder: (context) => Buddy_Loginwrapper(),));},

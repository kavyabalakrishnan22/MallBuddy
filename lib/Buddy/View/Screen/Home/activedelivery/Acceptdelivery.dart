...
class BuddyAcceptdeliverywrapper extends StatelessWidget {
  const BuddyAcceptdeliverywrapper({super.key});
  ...
  Widget build(BuildContext context) {
    return BlocProvider<OrderBloc>(
      ...
      child: BuddyAcceptDeliveryPage(),
    );
  }
}

class BuddyAcceptDeliveryPage extends StatelessWidget {
